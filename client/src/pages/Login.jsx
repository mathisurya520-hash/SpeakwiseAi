    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative pt-12">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black/40 border border-white/10 rounded-xl py-3.5 pl-12 pr-4 text-sm text-white focus:outline-none focus:border-neonCyan transition-colors font-mono animate-none"
              />
            </div>
          </div>
          ...
          >
            {loading ? 'Initializing Interface...' : 'Verify Identity'}
          </button>
        </form>

        <div className="mt-8 text-center text-xs text-gray-400">
          <span>Don't have access credentials? </span>
          <Link to="/signup" className="text-neonCyan hover:underline font-semibold">
            Request Access
          </Link>
        </div>
      </motion.div>
